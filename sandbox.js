...
Ітератор - об'єкт, за допомогою якого можна 
перебирати скруктури не знаючи їхнього внутрішнього влаштування.

Ітератор має метод next() - повертає наступний елемент колекції
                            та властивість done (чи завершили ми обход об'єкту, чи ні)
